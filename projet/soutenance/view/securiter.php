...
<div class="container  se-pubform">
	<div class="mt-3">
		...
		<table class="table">
		    ...
		    <tr>
		      ...
		      <td><?php echo $_SESSION['nom_util'] ;  ?></td>
		    ...
		    <tr>
		      ...
		      <td><a href="contact.php">Modifier</a></td>
	...
	<div>
		...
		<a href="Aprofile.php" class="btn  exo-btn ">Valider mon profil</a>
		
		<a href="Vente.php" class="btn  exo-btn ">Gérer mes ventes</a>

		<a href="Achat.php" class="btn  exo-btn ">Gérer mes achats</a>
