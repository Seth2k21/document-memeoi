<?php
session_start();
 require_once('../contoler/pvente.php');
?>
...
<div class="container  se-pubform">
	<div class="mt-3">
		<div class="mb-3">
		<h2 class="justify-content-center d-flex ">Gérer mes Ventes</h2>
		</div>
		<table class="table">
		  	  <tbody>
		  	 <?php
           ...
           ?>  	
		    ...
		    <tr>
		      ...
		      <td><button class="btn btn-secondary" type="submit"><?php echo $donne['statut'] ;  ?></button></td>
