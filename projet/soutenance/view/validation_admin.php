...
<?php session_start(); 
 ...
 require_once('../contoler/adm_val.php');
?>
<!DOCTYPE html>
<html>
<head>
...
<div class="container  se-pubform">
  <div class="mt-3">
    <div class="mb-3">
    <h2 class="justify-content-center d-flex ">Validation de compte</h2>
    </div>
    <table class="table table-striped">
          ...
          <td>email</td>
          <td>Adresse</td>
          <td>Numéro carte d'identité</td>
          <td>Image carte  d'identité</td>
        ...
        <tr>
          ...
          <td><?php echo $donne['adress_resid'] ;  ?></td>
          <td><?php echo $donne['num_card'] ;  ?></td>
          <td> <a href="<?php echo $donne['photo_card'] ;  ?>"> Afficher l'image</a> </td>
          ...
          <td><button class="btn btn-secondary" name="admin" value="ok" type="submit">Valider </button></td>
          </form>
        </tr>
      <?php
             }
