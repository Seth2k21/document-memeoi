...
<?php
   ...
   require_once('../contoler/c_mdpmodif.php');
...
<div>
	<div class="container forms" >
		<div class="container-fluid ">
			...
			<p class="ty mt-5 ">Entrer le nouveau mot de passe.</p>
		</div>
		...
		<div class="mt-5">
			<form  id="fform" method="POST">
				...
				<button type="submit" name="modif" value="azerty" class="btn btn-primary exo-btn mt-5 mb-5">Modifier</button>
			</form>
