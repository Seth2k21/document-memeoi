...
<?php
   ...
   require_once('../contoler/c_mdpoubl.php');
...
<div>
	<div class="container forms" >
		<div class="container-fluid ">
			...
			<p class="ty mt-5 ">Entrer votre adresse email.</p>
		</div>
		...
		<form  id="fform" method="POST">
				...
				<button type="submit" name="valider" value="azerty" class="btn btn-primary exo-btn mt-5 mb-5">Recuperer</button>
			</form>
			<div class="d-flex">
