 ...
 **/
  ...
  // Database object class
    ...
    // Create and return a database connection stream
          ...
          $data_base_connector = new PDO('mysql:host=localhost; dbname=market; charset=utf8', 'jack', 'jack');             return $data_base_connector;
    ...
    public function afficherou($table, $field, $sfield, $value)
    {
          // get and return a database object
      $db=$this->conn();
      ...
      public function afficherand($table, $field, $sfield1, $sfield2, $values)
    {
      ...
      public function afficherandr($table, $field, $sfield1, $sfield2, $values)
    {
          // get and return a database object
      $db=$this->conn();
      $read_request=$db->prepare('SELECT '.$field.' FROM '.$table.' WHERE '.$sfield1.'=? AND '.$sfield2.'=?ORDER BY rand()');
      $read_request->execute($values);
      return $read_request;
    }
